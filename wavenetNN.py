...
class wavenetNN:
    ...
    def trainModel(self, x_train, y_train, cellPosition):
        ...
        numSamples = np.shape(y_train)[0] #y.size will return number of cells, not number of rows.
    ...
    def initParams(self):
        ...
        W1 = np.random.randn(self.input_layer_neurons,9) * 0.01 #12 neurons of 81 dimensions, to align with input matrix
        #note that these neurons are of size (m,9) because these are dealing with sub-blocks of a sudoku, not the entire puzzle
